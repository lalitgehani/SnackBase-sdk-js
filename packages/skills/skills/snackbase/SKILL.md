...
description: >
  ...
  Use when working with the SnackBase-js client library (@snackbase/sdk ≥ 0.6.0) for any of
...
Aligned with **@snackbase/sdk ≥ 0.6.0**. Skills document the TypeScript client only
